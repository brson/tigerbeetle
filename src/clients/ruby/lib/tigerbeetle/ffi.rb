...
module TigerBeetle
  module FFI
    ...
    ClientStatus = enum(::FFI::Type::INT, [
      :OK, 0,
      :INVALID, 1,
    ])

    LogLevel = enum(::FFI::Type::INT, [
      :ERR, 0,
      :WARN, 1,
      :INFO, 2,
      :DEBUG, 3,
    ...
    RegisterLogCallbackStatus = enum(::FFI::Type::INT, [
      :SUCCESS, 0,
