...
//! # Todo
//!
//! - provide filter limit constants
//! - Client::new should take array of IpAddr?
//! - write api docs
//! - assign error code numbers to every error variant, add tests
//! - CreateAccountResult -> CreateAccountError etc?
//! - remove Unknown error variants?
//! - do error types need Eq, PartialEq?
//! - make (generated) readme
//! - is PacketStatus the right error type for requests?
//! - MSRV
...
/// The tb_client completion context is unused by the Rust bindingns.
