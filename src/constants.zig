...
/// search this many windows before giving up. This number is determined experimentally
/// and attempts to keep the search time under 1ms,
///
/// todo this needs to be chosen more carefully.
pub const lsm_manifest_coalesce_max_windows_to_search = 1024;
