...
pub fn ManifestLevelType(
    ...
    return struct {
        ...
        pub fn init(allocator: mem.Allocator, compstrat: *const CompStrat) !Self {
...
pub fn TestContext(
    ...
    return struct {
        ...
        fn init(random: std.rand.Random) !Self {
            var compstrat = try CompStrat.init(testing.allocator);
            errdefer compstrat.deinit(testing.allocator);
            ...
            var level = try TestLevel.init(testing.allocator, compstrat);
